...
namespace OBAService.Utils
{
    ...
    public class AADSettings
    {
        ...
        /// Initializes a new instance of the <see cref="AADSettings"/> class.
        /// </summary>
        /// <param name="tenantId">AAD tenant ID (Microsoft id most likely)</param>
        /// <param name="clientId">AAD client ID</param>
        /// <param name="appUri">Application URI</param>
        /// <param name="certThumbprint">thumbprint of certificate</param>
        public AADSettings(string tenantId, string clientId, string appUri, string certThumbprint)
        {
